...
<div class="max-w-2xl mx-auto py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-4">
            ...
            <p class="text-green-100 text-sm">Withdraw your wallet balance</p>
        </div>
        ...
        <div class="p-6">
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-2xl font-bold text-green-600">TSh {{ number_format($user->wallet_balance, 2) }}</span>
                </div>
            ...
            <form method="POST" action="{{ route('withdrawals.store') }}">
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1">Minimum: TSh {{ number_format($minWithdrawal, 2) }} | Maximum: TSh {{ number_format($user->wallet_balance, 2) }}</p>
                ...
                <div class="flex gap-3 mt-8 pt-6 border-t">
                    ...
                    <a href="{{ route('withdrawals.index') }}" class="px-6 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition text-center">
                        Cancel
                    </a>
                </div>
            </form>
