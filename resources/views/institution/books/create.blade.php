...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <a href="{{ route('institution.books.index') }}" class="text-purple-400 hover:text-purple-300 transition inline-flex items-center gap-1">
    ...
    <div class="bg-slate-900 border border-slate-700 rounded-2xl overflow-hidden">
        <div class="bg-gradient-to-r from-purple-900/30 to-pink-900/30 px-6 py-4 border-b border-slate-700">
            ...
            <p class="text-slate-400 text-sm">Add a book to your institution library</p>
        </div>

        <form method="POST" action="{{ route('institution.books.store') }}" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" class="search-bar">{{ old('description') }}</textarea>
                ...
                <div class="border-t border-slate-700 pt-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-1">Max 2MB. Allowed: JPG, PNG, JPEG</p>
                        ...
                        <div>
                            ...
                            <input type="file" name="file" accept=".pdf"
                                   class="w-full px-4 py-2.5 bg-slate-800 border border-slate-700 rounded-lg file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-purple-500/20 file:text-purple-300 hover:file:bg-purple-500/30 text-slate-300">
                            <p class="text-xs text-slate-500 mt-1">Max 10MB. Allowed: PDF</p>
                ...
                <div class="flex gap-3 pt-6 border-t border-slate-700">
                    ...
                    <a href="{{ route('institution.books.index') }}" class="bg-slate-800 text-slate-400 px-6 py-2.5 rounded-lg hover:bg-slate-700 transition text-center border border-slate-700">
                        Cancel
                    </a>
                </div>
