...
@php
    ...
    if (!auth()->user()->can('create', App\Models\Quote::class)) {
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
            ...
            <p class="text-blue-100 text-sm">Create a quote for {{ $institution->name }}</p>
        </div>
        
        <div class="bg-yellow-50 border-b border-yellow-200 p-4">
            <div class="flex items-center gap-2">
                <i class="ti ti-info-circle text-yellow-600"></i>
                <p class="text-sm text-yellow-800">This quote will only be visible to members of <strong>{{ $institution->name }}</strong></p>
            </div>
        </div>
