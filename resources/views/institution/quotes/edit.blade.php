...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
            ...
            <p class="text-blue-100 text-sm">Update quote for {{ auth()->user()->institution->name }}</p>
        </div>
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <textarea name="quote_text" rows="4" required 
                              class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500">{{ old('quote_text', $quote->quote_text) }}</textarea>
