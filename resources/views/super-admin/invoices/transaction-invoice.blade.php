...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .text-success { color: #1a7a3a; }
        .text-danger { color: #b33a3a; }
    ...
    <table class="items-table">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <span class="{{ $type === 'Credit' ? 'text-success' : 'text-danger' }}">
                        {{ $type ?? 'N/A' }}
                    </span>
                </td>
                <td class="text-right amount">
                    <span class="{{ $type === 'Credit' ? 'text-success' : 'text-danger' }}">
                        {{ $type === 'Credit' ? '+' : '-' }} TSh {{ number_format($amount ?? 0, 2) }}
                    </span>
                </td>
            </tr>
            @if(isset($balance_after))
            <tr>
                <td colspan="2" style="font-size:13px; color:#888;">
                    <strong>Balance After:</strong> TSh {{ number_format($balance_after ?? 0, 2) }}
                </td>
                <td></td>
            </tr>
            @endif
