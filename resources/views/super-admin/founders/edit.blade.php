...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 max-w-3xl">
        <form action="{{ route('super-admin.founders.update', $founder) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <!-- New Photo -->
            <div class="mb-4">
                <label for="photo" class="block text-sm font-medium text-gray-700 mb-1">New Photo (leave blank to keep current)</label>
