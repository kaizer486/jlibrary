...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        <a href="{{ route('super-admin.quotes.index') }}" class="text-purple-600 hover:text-purple-700">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="bg-gradient-to-r from-yellow-500 to-red-500 px-6 py-4">
            <h1 class="text-xl font-bold text-white">✏️ Edit Quote</h1>
            <p class="text-yellow-100 text-sm">Update the quote details below</p>
        </div>
        
        <form method="POST" action="{{ route('super-admin.quotes.update', $quote) }}" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <textarea name="quote_text" rows="4" required 
                              ...
                              placeholder="Enter an inspiring quote...">{{ old('quote_text', $quote->quote_text) }}</textarea>
            ...
            <div class="flex gap-3 mt-8 pt-6 border-t">
                <button type="submit" class="flex-1 bg-gradient-to-r from-yellow-500 to-red-500 text-white px-6 py-3 rounded-lg hover:shadow-lg transition font-semibold">
                    <i class="ti ti-device-floppy"></i> Update Quote
                </button>
                <a href="{{ route('super-admin.quotes.index') }}" class="px-6 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition text-center">
                    Cancel
                </a>
            </div>
        </form>
