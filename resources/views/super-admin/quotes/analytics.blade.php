...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <div class="bg-gradient-to-r from-yellow-500 to-red-500 px-6 py-4">
            ...
            <p class="text-yellow-100 text-sm">Performance metrics for this quote</p>
        </div>
        
        <div class="p-6">
            <!-- Quote Display -->
            <div class="bg-gradient-to-r from-yellow-50 to-red-50 rounded-xl p-6 mb-6 text-center">
                <i class="ti ti-quote text-3xl text-yellow-500 mb-2 block"></i>
            ...
            <div class="bg-gray-50 rounded-xl p-4">
                ...
                <div class="flex items-center gap-3">
                    <div class="flex-1 bg-gray-200 rounded-full h-3">
                        <div class="bg-gradient-to-r from-yellow-500 to-red-500 h-3 rounded-full" style="width: {{ min($engagementRate, 100) }}%"></div>
                    </div>
                    <span class="text-sm font-semibold text-yellow-600">{{ $engagementRate }}%</span>
                </div>
