...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
        <div class="bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-4">
            ...
            <p class="text-purple-200 text-sm mt-1">Register a new institution on the platform</p>
        </div>

        <form method="POST" action="{{ route('super-admin.institutions.store') }}" class="p-6">
            @csrf
            ...
            <div class="grid md:grid-cols-2 gap-5">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="2" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl">{{ old('address') }}</textarea>
                </div>
