...
<div class="max-w-5xl mx-auto">
    <div class="mb-6">
        <a href="{{ route('super-admin.applications.index') }}" class="text-purple-600 hover:text-purple-700 flex items-center gap-2">
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <p class="capitalize">{{ $application->type }}</p>
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div class="p-6">
                    <div class="grid md:grid-cols-2 gap-4">
                        ...
                        <form method="POST" action="{{ route('super-admin.applications.reject', $application) }}" id="reject-form">
                            @csrf
                            <textarea name="admin_notes" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg mb-2" placeholder="Reason for rejection... (required)"></textarea>
