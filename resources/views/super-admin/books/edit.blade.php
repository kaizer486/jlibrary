    ...
    <div>
        ...
        @error('sub_category') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
            ...
            <div class="grid md:grid-cols-4 gap-4 mt-5">
                ...
                <label class="flex items-center gap-3 cursor-pointer p-3 bg-gray-50 rounded-xl">
                    <input type="checkbox" name="is_featured" value="1" {{ $book->is_featured ? 'checked' : '' }} class="w-4 h-4 text-yellow-600 rounded">
                    <span class="text-sm text-gray-700">⭐ Featured</span>
                </label>
                
                <label class="flex items-center gap-3 cursor-pointer p-3 bg-gray-50 rounded-xl">
                    <input type="checkbox" name="is_trending" value="1" {{ $book->is_trending ? 'checked' : '' }} class="w-4 h-4 text-orange-600 rounded">
                ...
                <div>
                    ...
                    <select name="status" class="w-full px-3 py-2 border border-gray-300 rounded-xl bg-white">
