...
<div class="mb-6">
    <div class="flex justify-between items-center flex-wrap gap-4">
        ...
        <a href="{{ route('super-admin.books.create') }}" class="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-5 py-2.5 rounded-xl hover:shadow-lg transition flex items-center gap-2 font-semibold">
...
<div class="bg-white rounded-xl shadow-sm p-4 mb-6">
    <form method="GET" action="{{ route('super-admin.books.index') }}" class="flex flex-col md:flex-row gap-4">
        ...
        <div>
            <a href="{{ route('super-admin.books.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition inline-block">Clear</a>
        </div>
    </form>
</div>
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
    ...
    @endif
                    ...
                    <td class="px-6 py-4">
                        <form action="{{ route('super-admin.books.toggle-status', $book) }}" method="POST" class="inline-block">
                            @csrf
