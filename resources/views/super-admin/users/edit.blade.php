    ...
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
        ...
        <form method="POST" action="{{ route('super-admin.users.update', $user) }}" class="p-6">
            ...
            <div class="space-y-5">
                ...
                <div id="institution-fields" style="display: {{ in_array($user->role, ['institution_admin', 'school_admin', 'college_admin', 'university_admin', 'library_admin', 'bookstore_admin', 'publisher_admin', 'librarian', 'instructor']) ? 'block' : 'none' }};" class="p-4 bg-gray-50 rounded-xl">
