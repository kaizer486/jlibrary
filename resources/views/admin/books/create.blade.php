...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
        <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4">
            ...
            <p class="text-indigo-200 text-sm mt-1">Add a new book to the library collection</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.books.store') }}" enctype="multipart/form-data" class="p-6">
            ...
            <div class="grid md:grid-cols-3 gap-4 mt-5">
                <label class="flex items-center gap-3 cursor-pointer p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
                    <input type="checkbox" name="is_paid" value="1" {{ old('is_paid') ? 'checked' : '' }} class="w-4 h-4 text-indigo-600 rounded focus:ring-indigo-500">
                    <span class="text-sm text-gray-700">💰 Paid Book</span>
                </label>
                
                <label class="flex items-center gap-3 cursor-pointer p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
                    <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="w-4 h-4 text-yellow-600 rounded focus:ring-yellow-500">
                    <span class="text-sm text-gray-700">⭐ Featured</span>
                </label>
                
                <label class="flex items-center gap-3 cursor-pointer p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition">
                    <input type="checkbox" name="is_trending" value="1" {{ old('is_trending') ? 'checked' : '' }} class="w-4 h-4 text-orange-600 rounded focus:ring-orange-500">
