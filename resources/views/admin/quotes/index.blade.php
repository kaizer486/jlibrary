...
<div class="mb-6">
    <div class="flex justify-between items-center flex-wrap gap-4">
        ...
        <a href="{{ route('admin.quotes.create') }}" class="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition flex items-center gap-2">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <p class="text-sm text-blue-800">
                ...
                Users without an institution will not see these quotes.
            </p>
        </div>
    </div>
</div>
...
<div class="bg-green-50 border-l-4 border-green-500 rounded-xl p-4 mb-6">
    <div class="flex items-center gap-3">
        <i class="ti ti-info-circle text-green-500 text-xl"></i>
        <div>
            <p class="text-sm text-green-800">
                <strong>Note:</strong> You are managing <strong>Global Quotes</strong>. These quotes will be visible to users who are not part of any institution.
            </p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-sm p-4 mb-6">
    <form method="GET" class="flex flex-col md:flex-row gap-4">
        ...
        <div>
            ...
            <a href="{{ route('admin.quotes.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 ml-2">Clear</a>
        </div>
    </form>
</div>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex gap-2">
                            <a href="{{ route('admin.quotes.edit', $quote) }}" class="text-blue-600 hover:text-blue-800" title="Edit">
                                <i class="ti ti-edit"></i>
                            </a>
                            <a href="{{ route('admin.quotes.analytics', $quote) }}" class="text-green-600 hover:text-green-800" title="Analytics">
