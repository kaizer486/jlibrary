...
<div class="mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900 flex items-center gap-2">
            <i class="ti ti-files text-indigo-600"></i>
            Applications
        </h1>
...
<div class="bg-white rounded-xl shadow-sm p-4 mb-6">
    <form method="GET" action="{{ route('admin.applications.index') }}" class="flex flex-col md:flex-row gap-4">
        ...
        <div>
            <a href="{{ route('admin.applications.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition inline-block">Clear</a>
        </div>
    </form>
</div>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-sm">
                        <a href="{{ route('admin.applications.show', $app) }}" class="text-indigo-600 hover:text-indigo-800 flex items-center gap-1">
