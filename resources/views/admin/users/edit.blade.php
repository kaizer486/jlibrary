...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}" class="p-6">
            ...
            <!-- User Avatar Preview -->
            <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-xl mb-6 border border-gray-200">
            ...
            <div class="space-y-5">
                ...
                <div id="institution-fields" style="display: {{ in_array($user->role, ['institution_admin', 'school_admin', 'college_admin', 'university_admin', 'library_admin', 'bookstore_admin', 'publisher_admin', 'librarian', 'instructor']) ? 'block' : 'none' }};" class="p-4 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="is_institution_admin" value="1" {{ old('is_institution_admin', $user->is_institution_admin) ? 'checked' : '' }} class="w-4 h-4 text-indigo-600 rounded focus:ring-indigo-500">
                ...
                <div class="border-t border-gray-200 pt-4 mt-2">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" id="change-password-checkbox" class="w-4 h-4 text-indigo-600 rounded focus:ring-indigo-500">
