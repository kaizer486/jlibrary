...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-slate-900 border border-slate-700 rounded-2xl overflow-hidden">
        <div class="bg-gradient-to-r from-purple-900/30 to-pink-900/30 px-6 py-4 border-b border-slate-700">
            ...
            <p class="text-slate-400 text-sm">Add a book to your library collection</p>
        </div>

        <form method="POST" action="{{ route('librarian.books.store') }}" enctype="multipart/form-data" class="p-6">
            @csrf
                ...
                <div class="border-t border-slate-700 pt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="column_location" value="{{ old('column_location') }}"
                                   class="search-bar">
