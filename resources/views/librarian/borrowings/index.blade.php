...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        <a href="{{ route('librarian.borrowings.create') }}" class="btn-library">
    ...
    <div class="bg-slate-900 border border-slate-700 rounded-xl p-4 mb-6">
        <form method="GET" class="flex flex-wrap gap-3">
            ...
            <a href="{{ route('librarian.borrowings.index') }}" class="bg-slate-800 text-slate-400 px-4 py-2 rounded-lg hover:bg-slate-700 transition border border-slate-700">
                                ...
                                <td class="px-4 py-3 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        @if($borrowing->isActive())
                                            <form method="POST" action="{{ route('librarian.borrowings.return', $borrowing) }}" class="inline">
                                                @csrf
                                        ...
                                        @endif
                                        <a href="{{ route('librarian.borrowings.show', $borrowing) }}" class="text-purple-400 hover:text-purple-300 transition" title="View">
                                            <i class="ti ti-eye"></i>
                                        </a>
                                        @if($borrowing->isActive())
                                            <form method="POST" action="{{ route('librarian.borrowings.destroy', $borrowing) }}" 
