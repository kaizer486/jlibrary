...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-6">
        <a href="{{ route('librarian.borrowings.index') }}" class="text-purple-400 hover:text-purple-300 transition inline-flex items-center gap-1">
    ...
    <div class="bg-slate-900 border border-slate-700 rounded-2xl overflow-hidden">
        ...
        <form method="POST" action="{{ route('librarian.borrowings.store') }}" class="p-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="flex gap-3 pt-6 border-t border-slate-700">
                    ...
                    <a href="{{ route('librarian.borrowings.index') }}" class="bg-slate-800 text-slate-400 px-6 py-2.5 rounded-lg hover:bg-slate-700 transition text-center border border-slate-700">
                        Cancel
                    </a>
                </div>
