...
use App\Http\Controllers\SellerController; // ADD THIS
use App\Http\Controllers\Admin\ApplicationController as AdminApplicationController; // ADD THIS
use App\Http\Controllers\SuperAdmin\ApplicationController as SuperAdminApplicationController; // ADD THIS
...
// ==========================================
// PUBLIC LIBRARY ROUTES (Visitors/Non-authenticated)
// ==========================================
Route::prefix('library')->name('library.public.')->group(function () {
    Route::get('/{institutionId}', [PublicController::class, 'index'])->name('index');
    Route::get('/{institutionId}/book/{bookId}', [PublicController::class, 'show'])->name('show');
});

// ==========================================
// PUBLIC INSTITUTION LIBRARY ROUTES
// ==========================================
...
// ==========================================
// PLATFORM-WIDE LIBRARY (Public - Available to all)
// ==========================================
...
Route::middleware(['auth'])->group(function () {
    ...
    // ==========================================
    // PLATFORM-WIDE LIBRARY (All authenticated users)
    // ==========================================
    ...
    Route::get('/book/purchase/history', [BookPurchaseController::class, 'purchaseHistory'])->name('library.purchase.history');
  ...
  // ==========================================
// SELLER ROUTES (Using Spatie Role Middleware)
// ==========================================
...
// ==========================================
// MARKETPLACE MANAGEMENT (Authors & Booksellers)
// ==========================================
...
Route::prefix('author')->name('author.')->group(function () {
    ...
    Route::middleware(['auth', 'institution'])
        ...
        ->group(function () {
            ...
            Route::get('/subscription', [App\Http\Controllers\Institution\SubscriptionController::class, 'index'])->name('subscription.index');
            Route::post('/subscription/extend', [App\Http\Controllers\Institution\SubscriptionController::class, 'extend'])->name('subscription.extend');
            Route::get('/subscription/history', [App\Http\Controllers\Institution\SubscriptionController::class, 'history'])->name('subscription.history');
            Route::post('/subscription/cancel', [App\Http\Controllers\Institution\SubscriptionController::class, 'cancel'])->name('subscription.cancel');
        });
    
    // ==========================================
    // INSTITUTION MEMBER ROUTES
    // ==========================================
    Route::middleware(['institution'])
        ->prefix('institution')
        ->name('institution.')
        ->group(function () {
...
// Hero Slides Management
    ...
    // ==========================================
    // SUPER ADMIN APPLICATIONS (Using the correct controller)
    // ==========================================
...
// ==========================================
// ADMIN ROUTES (Content management only)
// ==========================================
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // ==========================================
    // ADMIN APPLICATIONS (Using the correct controller)
    // ==========================================
