...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'ai.providers.gemini.api_key' => 'string',
            'ai.providers.gemini.model' => 'string',
            'ai.providers.gemini.base_url' => 'string',
            'ai.providers.gemini.with_web_search' => 'boolean',
            'ai.features.web_search' => 'boolean',
            'ai.features.file_search' => 'boolean',
            'ai.features.memory' => 'boolean',
            'ai.agent' => 'string',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            ...
            'filesystems.links.C:\wamp64\www\jlibrary\public\storage' => 'string',
            ...
            'payments.currencies.default' => 'string',
            'payments.currencies.symbol' => 'string',
            'payments.currencies.code' => 'string',
            'payments.gateways.mpesa.name' => 'string',
            'payments.gateways.mpesa.enabled' => 'boolean',
            'payments.gateways.mpesa.environment' => 'string',
            'payments.gateways.mpesa.consumer_key' => 'string',
            'payments.gateways.mpesa.consumer_secret' => 'string',
            'payments.gateways.mpesa.passkey' => 'string',
            'payments.gateways.mpesa.shortcode' => 'string',
            'payments.gateways.mpesa.callback_url' => 'string',
            'payments.gateways.mpesa.min_amount' => 'integer',
            'payments.gateways.mpesa.max_amount' => 'integer',
            'payments.gateways.mpesa.icon' => 'string',
            'payments.gateways.mpesa.color' => 'string',
            'payments.gateways.tigopesa.name' => 'string',
            'payments.gateways.tigopesa.enabled' => 'boolean',
            'payments.gateways.tigopesa.environment' => 'string',
            'payments.gateways.tigopesa.api_key' => 'string',
            'payments.gateways.tigopesa.api_secret' => 'string',
            'payments.gateways.tigopesa.shortcode' => 'string',
            'payments.gateways.tigopesa.callback_url' => 'string',
            'payments.gateways.tigopesa.min_amount' => 'integer',
            'payments.gateways.tigopesa.max_amount' => 'integer',
            'payments.gateways.tigopesa.icon' => 'string',
            'payments.gateways.tigopesa.color' => 'string',
            'payments.gateways.halopesa.name' => 'string',
            'payments.gateways.halopesa.enabled' => 'boolean',
            'payments.gateways.halopesa.environment' => 'string',
            'payments.gateways.halopesa.api_key' => 'string',
            'payments.gateways.halopesa.api_secret' => 'string',
            'payments.gateways.halopesa.shortcode' => 'string',
            'payments.gateways.halopesa.callback_url' => 'string',
            'payments.gateways.halopesa.min_amount' => 'integer',
            'payments.gateways.halopesa.max_amount' => 'integer',
            'payments.gateways.halopesa.icon' => 'string',
            'payments.gateways.halopesa.color' => 'string',
            'payments.gateways.card.name' => 'string',
            'payments.gateways.card.enabled' => 'boolean',
            'payments.gateways.card.driver' => 'string',
            'payments.gateways.card.public_key' => 'string',
            'payments.gateways.card.secret_key' => 'string',
            'payments.gateways.card.webhook_secret' => 'string',
            'payments.gateways.card.min_amount' => 'integer',
            'payments.gateways.card.max_amount' => 'integer',
            'payments.gateways.card.icon' => 'string',
            'payments.gateways.card.color' => 'string',
            'payments.gateways.bank.name' => 'string',
            'payments.gateways.bank.enabled' => 'boolean',
            'payments.gateways.bank.requires_approval' => 'boolean',
            'payments.gateways.bank.min_amount' => 'integer',
            'payments.gateways.bank.max_amount' => 'integer',
            'payments.gateways.bank.icon' => 'string',
            'payments.gateways.bank.color' => 'string',
            'payments.gateways.bank.bank_details.bank_name' => 'string',
            'payments.gateways.bank.bank_details.account_name' => 'string',
            'payments.gateways.bank.bank_details.account_number' => 'string',
            'payments.gateways.bank.bank_details.swift_code' => 'string',
            'payments.gateways.bank.bank_details.branch' => 'string',
            'payments.commission.marketplace_seller' => 'integer',
            'payments.commission.platform_fee' => 'integer',
...
'ai.default','ai.default_for_images','ai.default_for_audio','ai.default_for_transcription','ai.default_for_embeddings',
'ai.default_for_reranking','ai.caching.embeddings.cache','ai.caching.embeddings.store','ai.providers.gemini.driver','ai.providers.gemini.api_key',
'ai.providers.gemini.model','ai.providers.gemini.base_url','ai.providers.gemini.with_web_search','ai.features.web_search','ai.features.file_search',
'ai.features.memory','ai.agent','app.name','app.env','app.debug',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\wamp64\\www\\jlibrary\\public\\storage',
...
'mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','payments.currencies.default','payments.currencies.symbol',
'payments.currencies.code','payments.gateways.mpesa.name','payments.gateways.mpesa.enabled','payments.gateways.mpesa.environment','payments.gateways.mpesa.consumer_key',
'payments.gateways.mpesa.consumer_secret','payments.gateways.mpesa.passkey','payments.gateways.mpesa.shortcode','payments.gateways.mpesa.callback_url','payments.gateways.mpesa.min_amount',
'payments.gateways.mpesa.max_amount','payments.gateways.mpesa.icon','payments.gateways.mpesa.color','payments.gateways.tigopesa.name','payments.gateways.tigopesa.enabled',
'payments.gateways.tigopesa.environment','payments.gateways.tigopesa.api_key','payments.gateways.tigopesa.api_secret','payments.gateways.tigopesa.shortcode','payments.gateways.tigopesa.callback_url',
'payments.gateways.tigopesa.min_amount','payments.gateways.tigopesa.max_amount','payments.gateways.tigopesa.icon','payments.gateways.tigopesa.color','payments.gateways.halopesa.name',
'payments.gateways.halopesa.enabled','payments.gateways.halopesa.environment','payments.gateways.halopesa.api_key','payments.gateways.halopesa.api_secret','payments.gateways.halopesa.shortcode',
'payments.gateways.halopesa.callback_url','payments.gateways.halopesa.min_amount','payments.gateways.halopesa.max_amount','payments.gateways.halopesa.icon','payments.gateways.halopesa.color',
'payments.gateways.card.name','payments.gateways.card.enabled','payments.gateways.card.driver','payments.gateways.card.public_key','payments.gateways.card.secret_key',
'payments.gateways.card.webhook_secret','payments.gateways.card.min_amount','payments.gateways.card.max_amount','payments.gateways.card.icon','payments.gateways.card.color',
'payments.gateways.bank.name','payments.gateways.bank.enabled','payments.gateways.bank.requires_approval','payments.gateways.bank.min_amount','payments.gateways.bank.max_amount',
'payments.gateways.bank.icon','payments.gateways.bank.color','payments.gateways.bank.bank_details.bank_name','payments.gateways.bank.bank_details.account_name','payments.gateways.bank.bank_details.account_number',
'payments.gateways.bank.bank_details.swift_code','payments.gateways.bank.bank_details.branch','payments.commission.marketplace_seller','payments.commission.platform_fee','queue.default',
...
'reverb.apps.apps.0.max_connections','reverb.apps.apps.0.max_message_size','reverb.apps.apps.0.accept_client_events_from','reverb.apps.apps.0.rate_limiting.enabled','reverb.apps.apps.0.rate_limiting.max_attempts',
'reverb.apps.apps.0.rate_limiting.decay_seconds','reverb.apps.apps.0.rate_limiting.terminate_on_limit','services.postmark.key','services.resend.key','services.ses.key',
...
'session.partitioned','session.serialization','dompdf.show_warnings','dompdf.public_path','dompdf.convert_entities',
...
'signed','throttle','verified','admin',);
        registerArgumentsSet('routes', 'welcome','home','auth.google',
'auth.google.callback','auth.github','auth.github.callback','referral.process','dashboard',
'library.index','library.my-library','library.show','library.read','library.download',
'library.progress','library.add-to-library','books.purchase-info','books.purchase-wallet','books.check-purchase',
'payment.methods','payment.initiate','payment.save-details','payment.status','referrals.index',
'referrals.complete','search.index','search.live','search.filter','notifications.index',
'notifications.unread-count','notifications.latest','notifications.mark-all-read','notifications.mark-read','notifications.destroy',
'bookmark.toggle','bookmarks.index','bookmark.destroy','books.rate','books.review',
'reviews.helpful','books.rating.delete','books.review.delete','quizzes.index','quizzes.show',
'quizzes.submit','quizzes.results','quizzes.history','wallet.index','wallet.withdraw',
'wallet.topup','wallet.balance','profile.edit','profile.update','profile.avatar',
'profile.cover','profile.avatar.delete','profile.cover.delete','ai.chat','ai.chat.session',
'ai.send','ai.new','ai.delete','ai.get','certificates.index',
'certificates.generate','certificates.show','certificates.download','community.index','community.my-groups',
'community.create','community.store','community.show','community.join','community.leave',
'community.send-message','community.delete-message','community.messages','converter.index','converter.pdf-to-word',
'converter.word-to-pdf','converter.book-to-audio','marketplace.index','marketplace.my-listings','marketplace.create',
'marketplace.store','marketplace.show','marketplace.download','marketplace.destroy','documents.index',
'documents.create','documents.upload','documents.show','documents.ask','documents.destroy','admin.payments.approve','payment.mpesa.callback','payment.tigopesa.callback',
'payment.halopesa.callback','stripe.webhook','admin.dashboard','admin.analytics','admin.analytics.data',
'admin.books.index','admin.books.create','admin.books.store','admin.books.show','admin.books.edit',
'admin.books.update','admin.books.destroy','admin.books.toggle-status','admin.users.index','admin.users.create',
'admin.users.store','admin.users.show','admin.users.edit','admin.users.update','admin.users.destroy',
'admin.users.toggle-role','admin.marketplace.pending','admin.marketplace.all','admin.marketplace.approve','admin.marketplace.reject',
'admin.payments.index','profile.show','register','login','password.request','password.email','password.reset','password.store',
...
'admin.analytics','admin.books.create','admin.books.index','admin.books.view','admin.dashboard',
'admin.marketplace.pending','admin.payment.index','admin.users.index','admin.users.show','ai.chat',
'ai.quiz','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','bookmarks.index','certificates.index','certificates.show',
'certificates.template','community.create','community.index','community.my-groups','community.show',
'components.application-logo','components.auth-session-status','components.bookmark-button','components.danger-button','components.dropdown',
'components.dropdown-link','components.input-error','components.input-label','components.modal','components.nav-link',
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.star-rating','components.text-input',
'converter.index','dashboard','documents.index','documents.show','documents.upload',
'emails.book-access','emails.certificate-earned','emails.layouts.email','emails.purchase-confirmation','emails.quiz-passed',
'emails.welcome','layouts.admin','layouts.app','layouts.guest','layouts.navigation',
'layouts.sidebar','library.index','library.my-library','library.show','marketplace.all',
'marketplace.create','marketplace.index','marketplace.my-listings','marketplace.show','notifications.index',
'payment.methods','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'profile.show','quizzes.index','quizzes.results','quizzes.take','referrals.index',
'search.index','wallet.index','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.wamp64.www.jlibrary.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','AI_PROVIDER','GEMINI_API_KEY','GEMINI_MODEL',
'AI_WEB_SEARCH','AI_FILE_SEARCH','AI_MEMORY','BROADCAST_CONNECTION','REVERB_APP_ID',
...
'GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI','GITHUB_CLIENT_ID','GITHUB_CLIENT_SECRET',
'GITHUB_REDIRECT_URI','MPESA_ENABLED','MPESA_ENVIRONMENT','MPESA_CONSUMER_KEY','MPESA_CONSUMER_SECRET',
'MPESA_PASSKEY','MPESA_SHORTCODE','MPESA_CALLBACK_URL','TIGOPESA_ENABLED','TIGOPESA_ENVIRONMENT',
'TIGOPESA_API_KEY','TIGOPESA_API_SECRET','TIGOPESA_SHORTCODE','TIGOPESA_CALLBACK_URL','HALOPESA_ENABLED',
'HALOPESA_ENVIRONMENT','HALOPESA_API_KEY','HALOPESA_API_SECRET','HALOPESA_SHORTCODE','HALOPESA_CALLBACK_URL',
'STRIPE_ENABLED','STRIPE_KEY','STRIPE_SECRET','STRIPE_WEBHOOK_SECRET','BANK_ENABLED',
