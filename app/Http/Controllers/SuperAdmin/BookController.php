...
class BookController extends Controller
{
    public function index(Request $request)
    {
      $query = Book::with('uploader');
        ...
        return view('super-admin.books.index', compact('books', 'totalBooks', 'approvedBooks', 'pendingBooks', 'freeBooks', 'institutions'));
    }
    
    public function create()
    {
        $institutions = Institution::where('status', 'approved')->get();
        return view('super-admin.books.create', compact('institutions'));
    }
    ...
    {
        $institutions = Institution::where('status', 'approved')->get();
        return view('super-admin.books.edit', compact('book', 'institutions'));
    }
    ...
    public function update(Request $request, Book $book)
    {
        ...
        return redirect()->route('super-admin.books.index')->with('success', 'Book updated successfully!');
    }
    ...
    public function destroy(Book $book)
    {
        ...
        return redirect()->route('super-admin.books.index')->with('success', 'Book deleted successfully!');
    }
